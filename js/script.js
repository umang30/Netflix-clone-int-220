...
document.addEventListener('DOMContentLoaded', function() {
    ...
    lang2.addEventListener('change',event => {
        if(lang2[lang2.selectedIndex].value == 'hi' && document.URL=='http://localhost/int220/'){
            window.location.href = '/int220/in-hi/';
        } else if(lang2[lang2.selectedIndex].value == 'en' && document.URL=='http://localhost/int220/in-hi/'){
            window.location.href = '/int220/';
        }
    });
});